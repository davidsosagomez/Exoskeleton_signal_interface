...
if __name__ == '__main__':
    rospy.init_node('pose_matrix_converter_test')

    rospy.Subscriber('/pos_rot2', PosRot, pose_callback)

    pub = rospy.Publisher('/T_trackerEE', Float64MultiArray, queue_size=10)
